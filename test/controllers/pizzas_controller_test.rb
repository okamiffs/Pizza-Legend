...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { name: @pizza.name, size: @pizza.size, user_id: @pizza.user_id } }, as: :json
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { name: @pizza.name, size: @pizza.size, user_id: @pizza.user_id } }, as: :json
    assert_response 200
  end
